...
public class OperadoresAritmeticos {
    public static void main(String[] args) {
        ...
        Integer modulo = 7 % 4;     // O módulo sempre mostrará o resto da divisão.
        System.out.println("Módulo: " + modulo);

        Integer precedencia01 = 1 + 1 * 5;
        System.out.println("Precedência 01: " + precedencia01);

        Integer precedencia02 = (1 + 1) * 5; // Prioridade para o calculo dentro do parêteses.
        System.out.println("Precedência 02: " + precedencia02);

        Integer precedencia03 = 5 * (1 + 1); // Prioridade para o calculo dentro do parênteses.
        System.out.println("Precedência 03: " + precedencia03);

        Integer precedencia04 = 5 * (1 + 1) + 2; // Prioridade para o que está dentro do parênteses
